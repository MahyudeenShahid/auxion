                    ...
                    <div className="flex flex-col gap-12 lg:gap-16">
                        {stacks.map((stack, idx) => (
                            <motion.div
                                ...
                                transition={{ duration: 0.8, ease: [0.16, 1, 0.3, 1] }}
                                className="group relative w-full bg-[#050505] border border-white/10 rounded-[2rem] overflow-hidden flex flex-col lg:flex-row transition-all duration-700 hover:border-white/20 hover:shadow-[0_20px_50px_rgba(0,0,0,0.5)]"
                            >
                                ...
                                <div className="hidden lg:flex flex-col items-center justify-center p-12 border-r border-white/5 relative z-10 min-w-[150px]">
                                    <h3 className="font-mono text-5xl font-black text-white/10 group-hover:text-white/30 transition-colors duration-500">
                                        0{idx + 1}
                                    </h3>
                                    <motion.div 
                                ...
                                <div className="flex-1 p-8 lg:p-12 relative z-10 flex flex-col justify-center">
                                    ...
                                    <h2 className="text-3xl md:text-4xl lg:text-5xl font-black uppercase tracking-tight text-white mb-6">
                                        {stack.name}
                                    </h2>
                                    ...
                                    <div className="flex flex-wrap gap-3">
                                        {stack.features.map((feature, i) => (
                                            <motion.div 
                                                ...
                                                className="px-4 py-2 rounded-full border border-white/10 bg-white/5 flex items-center gap-2 group/pill cursor-default hover:bg-white/10 hover:border-white/20 shadow-sm hover:shadow-md"
                                            >
                                                <span 
                                ...
                                {/* Right: Tech Stack */}
                                <div className="lg:w-[350px] p-8 lg:p-12 bg-black/40 border-t lg:border-t-0 lg:border-l border-white/5 relative z-10 flex flex-col justify-center">
                                    <div className="font-mono text-[10px] tracking-[0.2em] text-white/30 uppercase mb-8 flex items-center justify-between">
                                    ...
                                    <div className="grid grid-cols-2 gap-4 w-full">
                                        {stack.technologies.map((tech, i) => (
                                            ...
                                            >
                                                <div className="w-14 h-14 bg-[#080808] border border-white/5 rounded-[12px] flex items-center justify-center p-3 relative overflow-hidden transition-all duration-300 group-hover/tech:border-white/20 group-hover/tech:-translate-y-1 group-hover/tech:shadow-lg">
                                                    <div 
                                                ...
                                                <span className="font-mono text-[9px] text-gray-500 uppercase tracking-widest group-hover/tech:text-white transition-colors duration-300">
                                                    {tech.name}
                                                </span>
                                            </motion.div>
                                        ))}
